...
Como se mencionó anteriormente, este fue programado con el ambiente de Arduino IDE, utilizando un Arduino UNO como microcontrolador principal. El código fue escrito en C++, utilizando librerías estándar para el control de motores y sensores ultrasónicos, y con un enfoque orientado a objeto. 
